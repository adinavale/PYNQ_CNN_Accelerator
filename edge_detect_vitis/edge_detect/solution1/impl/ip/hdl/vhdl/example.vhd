...
architecture behav of example is 
    ...
    "example_example,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=40,HLS_SYN_LUT=84,HLS_VERSION=2022_2}";
...
begin
    ...
    B_TDATA_int_regslice <= std_logic_vector(shift_left(unsigned(A_TDATA_int_regslice),to_integer(unsigned('0' & ap_const_lv32_1(31-1 downto 0)))));
